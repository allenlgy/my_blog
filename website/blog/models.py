...
class Entry(models.Model):
    ...
    abstract = models.TextField('摘要',max_length=256,null=True)
    visiting = models.PositiveSmallIntegerField('访问量',default=0)
